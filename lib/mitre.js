...
export const MITRE_TECHNIQUES = [
  ...
  { id: 'T1489', name: 'Service Stop', tactic: 'Impact', pattern: /(?:stop|disable|kill)(?:s|ped|d|ing)?[ -](?:system[ -])?services?|\bnet stop\b|\bsc stop\b/i },
  { id: 'T1498', name: 'Network Denial of Service', tactic: 'Impact', pattern: /denial.?of.?service|\bddos\b|network.?flood/i },
  ...
  { id: 'T1003', name: 'OS Credential Dumping', tactic: 'Credential Access', pattern: /credential.?dump|lsass|mimikatz|ntds\.dit|hash.?dump/i },
  { id: 'T1558.003', name: 'Kerberoasting', tactic: 'Credential Access', pattern: /kerberoast/i },
  { id: 'T1558.001', name: 'Golden Ticket', tactic: 'Credential Access', pattern: /golden.?ticket/i },
  { id: 'T1558.002', name: 'Silver Ticket', tactic: 'Credential Access', pattern: /silver.?ticket/i },
  ...
  { id: 'T1098', name: 'Account Manipulation', tactic: 'Persistence', pattern: /account.?manipulat|(?:add|grant|change)[^.]{0,24}(?:account.?permission|account.?role|admin(?:istrator)?[ -]?privilege)/i },
  { id: 'T1136', name: 'Create Account', tactic: 'Persistence', pattern: /creat\w*[^.]{0,30}(?:admin(?:istrator)?[ -])?account/i },

...
const DomainPackSchema = z.object({
  ...
  brief: z.object({
    ...
    exemplars: z.object({
      ...
      responseCompleteness: z.string(), actionCoordination: z.string(), convergenceLimitations: z.string(), uncataloguedAction: z.string(),
    }).partial().optional(),
    grounding: z.object({
      ...
      eventTimingInstruction: z.string(), evidenceAvailabilityInstruction: z.string(), statisticalExample: z.string(),
    }).partial().optional(),

...
const DomainPackSchema = z.object({
  ...
  brief: z.object({
    ...
    exemplars: z.object({
      ...
      execAvoid: z.string(), actionOwners: z.string(), actionCatalogNote: z.string(), absentSpecific: z.string(),
      whatHappenedSpecifics: z.string(), numberExamples: z.string(),
    }).partial().optional(),
    grounding: z.object({ specifics: z.string(), systemFactsNote: z.string(), verifiedCatalog: z.string() }).partial().optional(),
